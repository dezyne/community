...
public class iUnity{
  ...
  public void check_bindings()
  {
    ...
    if (inport.reverse	== null) throw new dzn.binding_error(dzn_meta, "inport.reverse");

    if (outport.wallHit	 == null) throw new dzn.binding_error(dzn_meta, "outport.wallHit");
